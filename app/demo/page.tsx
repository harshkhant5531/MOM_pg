...
export default function DemoPage() {
    ...
    const demoFeatures = [
        { title: "Smart Scheduling", time: "0:45", icon: Calendar, description: "Automate participant availability and room assignments.", color: "blue" },
        { title: "Dynamic Action Items", time: "1:20", icon: Zap, description: "Track tasks directly from the dashboard with real-time updates.", color: "orange" },
        { title: "Collaborative MOMs", time: "2:15", icon: FileText, description: "Generate and securely store meeting minutes in seconds.", color: "indigo" },
        { title: "Role-based Insights", time: "3:40", icon: Users, description: "Custom dashboards for Admins, Conveners, and Staff.", color: "purple" },
    ];
        ...
        <div className="min-h-screen bg-slate-50 text-slate-900 relative overflow-hidden flex flex-col">
            ...
            <header className="relative z-20 max-w-7xl mx-auto w-full px-6 py-8 flex justify-between items-center">
                ...
                <div className="flex items-center gap-2 px-4 py-2 bg-white rounded-full shadow-sm border border-slate-100">
                    ...
                    <span className="text-[10px] font-black uppercase tracking-widest text-slate-600">Secure Product Tour</span>
                </div>
            </header>
            ...
            <main className="relative z-10 flex-1 max-w-7xl mx-auto w-full px-6 py-12 lg:py-20 flex flex-col items-center">
                ...
                <div className="text-center max-w-3xl mb-16">
                    ...
                    >
                        ...
                        <span className="text-sm font-medium text-slate-700">Experience the difference</span>
                    </motion.div>
                    <motion.h1
                    ...
                    >
                        Watch how MOM transforms chaotic organizations into efficient, documented, and accountable powerhouses.
                    </motion.p>
                </div>
                    ...
                    {!isPlaying ? (
                        <div className="absolute inset-0 flex flex-col items-center justify-center bg-[url('https://images.unsplash.com/photo-1517245386807-bb43f82c33c4?auto=format&fit=crop&q=80&w=2070')] bg-cover bg-center">
                            ...
                            <div className="relative z-10 mt-8 text-center text-white">
                                <span className="text-xs font-black uppercase tracking-widest opacity-80 mb-2 block">Play 5 Minute Demo</span>
                                <p className="text-2xl font-bold">The Modern Meeting Workflow</p>
                            </div>
                            ...
                            <div className="absolute bottom-8 left-8 right-8 flex justify-between items-center">
                                <div className="flex items-center gap-3 px-4 py-2 bg-white/20 backdrop-blur-md rounded-xl border border-white/30 text-white">
                                    ...
                                    <span className="text-[10px] font-black uppercase tracking-wider">v2.4 Live Demo</span>
                                </div>
                        ...
                        <div className="absolute inset-0 flex items-center justify-center bg-slate-900">
                            <div className="text-center space-y-6">
                                ...
                                <p className="text-indigo-400 font-black uppercase tracking-widest text-[10px]">Establishing secure connection...</p>
                                <button
                    ...
                    {demoFeatures.map((feature, idx) => (
                        ...
                        >
                            <div className="flex justify-between items-start mb-6">
                                <div className={`p-3 bg-${feature.color}-50 rounded-2xl group-hover:scale-110 transition-transform`}>
                                    <feature.icon className={`text-${feature.color}-600`} size={24} strokeWidth={2.5} />
                                </div>
                ...
                >
                    ...
                    <div className="relative z-10 max-w-2xl mx-auto">
                        ...
                        <p className="text-slate-500 mb-10 text-lg">Join 10,000+ teams who have transformed their meeting workflow with MOM.</p>
                        ...
                        <div className="mt-8 flex items-center justify-center gap-8 text-[10px] font-black text-slate-400 uppercase tracking-[0.2em]">
                            <div className="flex items-center gap-2">
                                <CheckCircle2 size={14} className="text-green-500" /> Free 14-day trial
                            </div>
                            <div className="flex items-center gap-2">
