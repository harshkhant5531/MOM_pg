    ...
    return (
        <div className="p-8 pb-20 max-w-[1400px] mx-auto space-y-10 animate-in fade-in duration-500">
            <header className="flex justify-between items-end">
                ...
                <button className="bg-blue-600 text-white px-8 py-3.5 rounded-3xl font-black text-[10px] uppercase tracking-widest flex items-center gap-2 hover:bg-blue-700 transition-all shadow-xl shadow-blue-500/20 active:scale-95">
                    <Plus size={20} /> Reserve Allocation
                </button>
            </header>
                    ...
                    filteredVenues.map((v) => (
                        <div key={v.VenueID} className="bg-white dark:bg-gray-900 p-8 rounded-[48px] border border-slate-100 dark:border-gray-800 shadow-2xl shadow-blue-500/5 group hover:border-blue-500/50 transition-all cursor-default">
                            ...
                            <div className="pt-8 border-t border-slate-50 dark:border-gray-800 flex justify-between items-center">
                                <span className="bg-blue-50 dark:bg-blue-900/30 text-blue-600 dark:text-blue-400 px-4 py-1.5 rounded-xl text-[10px] font-black uppercase tracking-widest">Available</span>
