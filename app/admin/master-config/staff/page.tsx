                    ...
                    <td className="px-8 py-6">
                      <div className="flex items-center justify-end gap-2">
                        <button
                          ...
                          className="cursor-pointer  p-2 text-slate-300 hover:text-blue-600 hover:bg-blue-50 rounded-lg transition-all"
                        >
                          <Edit2 size={16} />
                        </button>
                        <button
                          onClick={() => handleDelete(staff.StaffID)}
                          className=" cursor-pointer p-2 text-slate-300 hover:text-red-600 hover:bg-red-50 rounded-lg transition-all"
                        >
                          <Trash2 size={16} />
                        </button>
                      </div>
