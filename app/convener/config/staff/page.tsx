            ...
            <div className="bg-white dark:bg-gray-900 rounded-2xl shadow-sm border border-gray-100 dark:border-gray-800 overflow-hidden">
                {isLoading ? (
                    <div className="p-20 flex flex-col items-center justify-center text-slate-400 gap-3">
                        ...
                        <span className="font-bold uppercase tracking-widest text-[10px]">Syncing staff records...</span>
                    </div>
                ) : (
                        ...
                        <table className="w-full text-sm text-left">
                            ...
                            <tbody className="divide-y divide-gray-100 dark:divide-gray-800">
                                {filteredStaff.map((staff) => (
                                    <tr key={staff.StaffID} className="hover:bg-gray-50/50 dark:hover:bg-gray-800/50 transition-colors group">
                                        <td className="px-8 py-5">
                                            <div className="flex items-center gap-4">
                                                ...
                                                <span className="font-bold text-gray-900 dark:text-white">{staff.StaffName}</span>
                                            </div>
                                        </td>
                                        <td className="px-8 py-5">
                        ...
                        >
                            ...
                            <form onSubmit={handleSubmit} className="p-8 space-y-5">
                                ...
                                <div className="grid grid-cols-2 gap-4">
                                    ...
                                    <div className="space-y-1.5">
                                        <label className="text-xs font-black text-slate-400 uppercase tracking-widest">Mobile</label>
                                        <div className="relative">
                                ...
                                <div className="space-y-1.5">
                                    <label className="text-xs font-black text-slate-400 uppercase tracking-widest">Remarks</label>
                                    <div className="relative">
