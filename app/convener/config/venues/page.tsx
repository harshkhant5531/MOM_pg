        ...
        <div className="p-8 pb-20 max-w-[1400px] mx-auto">
            <div className="flex justify-between items-start mb-10">
                <div className="space-y-1">
                    <h1 className="text-3xl font-black text-slate-900 dark:text-white uppercase tracking-tight">Venues</h1>
                    <p className="text-slate-500 font-medium">Manage and configure meeting locations and their capacities</p>
                </div>
                <button
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                {isLoading ? (
                    Array(3).fill(0).map((_, i) => (
                        <div key={i} className="h-64 bg-white dark:bg-gray-900 rounded-3xl border border-slate-100 dark:border-gray-800 animate-pulse" />
                    ))
                    ...
                    >
                        <div className="p-8">
                            ...
                            <h3 className="text-xl font-black text-slate-800 dark:text-white capitalize mb-2">{venue.VenueName}</h3>
                            ...
                            <div className="flex items-center justify-between pt-6 border-t border-slate-50 dark:border-gray-800">
                                ...
                                <span className={`px-2 py-1 rounded-lg text-[10px] font-black uppercase tracking-wider ${venue.Capacity > 20 ? 'bg-orange-50 text-orange-600' : 'bg-green-50 text-green-600'
                                    }`}>
                        ...
                        >
                            <div className="p-8 border-b border-slate-50 dark:border-gray-800 flex items-center justify-between">
                                <div>
                                    <h2 className="text-xl font-black text-slate-900 dark:text-white uppercase tracking-tight">
                                        {editingVenue ? "Edit Venue Configuration" : "New Venue Setup"}
                                    </h2>
                                    <p className="text-slate-500 text-sm">Define meeting space parameters</p>
                                </div>
                            ...
                            <form onSubmit={handleSubmit} className="p-8 space-y-6">
                                <div className="space-y-1.5">
                                    <label className="text-xs font-black text-slate-400 uppercase tracking-widest">Venue Name</label>
                                ...
                                <div className="space-y-1.5">
                                    <label className="text-xs font-black text-slate-400 uppercase tracking-widest">Location Detail</label>
                                    <div className="relative">
