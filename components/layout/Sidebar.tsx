...
import { ChevronDown, Menu, LogOut, LucideIcon, Video } from "lucide-react";
...
export default function Sidebar({ items, user }: SidebarProps) {
  ...
  return (
    <aside
      className={`fixed left-0 top-0 z-40 h-screen transition-all duration-300 ease-in-out border-r border-[#E2E8F0] bg-[#0F172A] text-white ${
